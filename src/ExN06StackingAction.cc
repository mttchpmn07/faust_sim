...
ExN06StackingAction::ClassifyNewTrack(const G4Track * aTrack)
{
  ...
  { // particle is optical photon
   ...
   // ofstream dataFile ("Data.txt", ios_base::app);
   // dataFile <<gammaCounter << "  " << time  << endl;
   // //aTrack.SetGlobalTime(0.);
   // time = 0.0;
...
void ExN06StackingAction::NewStage()
{
  ...
  //       << gammaCounter << " in " << TotalTime << " ns." << G4endl;

  // EnergyTotal = (gammaCounter - 1.2167)/ 49.7361;

  //G4cout << "Total energy in event: " << EnergyTotal << G4endl;
  //cout << "I SUCK" << endl;
...
G4int ExN06StackingAction::GetGammaCounter()
{
  return gammaCounter;
