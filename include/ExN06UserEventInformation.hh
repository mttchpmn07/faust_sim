...
#ifndef ExN06UserEventInformation_h
#define ExN06UserEventInformation_h 1

class ExN06UserEventInformation : public G4VUserEventInformation
{
public:
  ExN06UserEventInformation();
  ~ExN06UserEventInformation();
